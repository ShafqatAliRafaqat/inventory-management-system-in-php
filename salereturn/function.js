...
//$.post('salereturn/edit.php',{voucher_no:voucher_no},function(data){
//$('#reload_voucher').html(data);
//});
location.href="salereturn.php?popup=no";
}
});
});
});
