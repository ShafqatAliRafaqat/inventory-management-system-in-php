...
<title>Stock Ledger Information</title>
...
<h4>Stock Ledger Information</h4>
</div>
</div>
<div class="panel-body">
<form role="form" id="form_new" method="post" class="validate form-horizontal form-groups-bordered">
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Product Code:<span id="star">*</span></label>
<div class="col-sm-3">
<input type="text" class="form-control" readonly id="account_code" placeholder="Product Code" name="account_code" required>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Product Name:<span id="star">*</span></label>
<div class="col-sm-3">
...
<?php
$query_account=Run("SELECT * FROM PRODUCT ORDER BY PRODUCTNAME ASC");
while($fetch_account=mssql_fetch_object($query_account))
{
$a=$fetch_account->PRODUCTCODE;
$b=$fetch_account->PRODUCTNAME;
?>
...
$.post("stock_reports/stock_ledger.php",{
