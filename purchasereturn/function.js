...
//$.post('purchasereturn/edit.php',{voucher_no:voucher_no},function(data){
//$('#reload_voucher').html(data);
//});
location.href="purchasereturn.php?popup=no";
}
});
});
});
...
$.ajax({
type: "POST",
url: "purchasereturn/address.php",
data:
{
code:code
},
