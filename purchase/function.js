...
//$.post('purchase/edit.php',{voucher_no:voucher_no},function(data){
//$('#reload_voucher').html(data);
//});
location.href="purchase.php?popup=no";
}
});
});
});
