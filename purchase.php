...
$id = $x->NO+1;
?>
<form role="form" id="form_new" action="purchase/save.php" enctype="multipart/form-data" onsubmit="return checkvalidation();" method="post" class="validate form-horizontal form-groups-bordered">
...
<script src="purchase/function.js" id="script-resource-8"></script>
<script src="purchase/row.js" id="script-resource-8"></script>
<?php
if($_GET['popup']=='yes')
{
?>
