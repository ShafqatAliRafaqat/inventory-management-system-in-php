...
<title>Supplier Ledger Information</title>
...
<h4>Supplier Ledger Information</h4>
</div>
</div>
<div class="panel-body">
<form role="form" id="form_new" method="post" class="validate form-horizontal form-groups-bordered">
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Supplier Code:<span id="star">*</span></label>
<div class="col-sm-3">
<input type="text" class="form-control" readonly id="account_code" placeholder="Code" name="account_code" required>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Supplier Name:<span id="star">*</span></label>
<div class="col-sm-3">
